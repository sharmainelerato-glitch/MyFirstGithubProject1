...
function search(event) {
  ...
  let apiUrl = "https://api.shecodes.io/weather/v1/current?query=".concat(city, "&key=").concat(apiKey, "&units=metric");
...
function formatDate(date) {
  ...
  return "".concat(formattedDay, " ").concat(hours, ":").concat(minutes);
}
